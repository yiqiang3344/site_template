...
(function(e, t) {
    ...
    st.Callbacks = function(e) {
        ...
        p = {
            ...
            remove: function() {
                ...
                function(e, t) {
                    for (var n;
                    (n = st.inArray(t, l, n)) > -1;) l.splice(n, 1),
                    o && (s >= n && s--, u >= n && u--)
                }),
                this
            },
    ...
    st.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return st.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n) for (var i, o = 0, a = st(this), s = t, u = e.match(lt) || []; i = u[o++];) s = r ? s: !a.hasClass(i),
    ...
    st.event = {
        ...
        trigger: function(n, r, i, o) {
            ...
            o || !p.trigger || p.trigger.apply(i, r) !== !1)) {
                ...
                for (a = 0;
                (s = d[a++]) && !n.isPropagationStopped();) n.type = a > 1 ? l: p.bindType || h,
    ...
    function(e, t) {
        st.fn[e] = function(e) {
            for (var n, r = 0, i = [], o = st(e), a = o.length - 1; a >= r; r++) n = r === a ? this: this.clone(!0),
            st(o[r])[t](n),
            tt.apply(i, n.get());

...
INSERT INTO `contact` VALUES ('1','contract_us','联系我们','<p>快点联系我们呀～</p>','1','2013-12-22 15:37:57','0','1387697877');DROP TABLE IF EXISTS `information`;
...
CREATE TABLE `link` (
  ...
  UNIQUE KEY `name` (`name`),
  UNIQUE KEY `url` (`url`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='导航外链';
...
INSERT INTO `user` VALUES ('1','test','d047038edabf6fd6b539f9ad78d88f3ae297652ac721c994a6678f63e963a0f91c99d692543ff0054656453b056cc1262998108ffa94644499eb3969b4254746','::1','2013-12-18 22:26:18','0','1387376778');
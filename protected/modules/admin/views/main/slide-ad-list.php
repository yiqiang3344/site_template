...
<script type="text/javascript">//static
    ...
    function content_refresh(){
        ...
        //分页
        Pager($('#page'),'Main','SlideAdList',{},params);

        //搜索
        $('#search').click(function(){
            var search = $('#search_type').val()+':'+$('#search_val').val();
            State.forward('Main','SlideAdList',{search:search,p:params.page});
        });
        //排序
        $('[id^=order_]').click(function(){
            var val = this.id.replace('order_',''),
                ...
                order_str = val+':'+sc;
            State.forward('Main','SlideAdList',{order:order_str,p:params.page});
        });
        //点击修改
        ...
        $('[id^=edit_]').click(function(){
            ...
            State.forward('Main','SlideAdEdit',{id:id});
            return false;
        });

        $('#add').click(function(){
            State.forward('Main','SlideAdEdit');
            return false;
        });

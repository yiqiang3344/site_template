...
return temstr;};return{set:function(text){return setCookie(uniqueN,text);},clear:function(){return delCookie(uniqueN);},get:function(){return getCookie(uniqueN);}};};window.State={};(function(){State.forward=function(c,a,p){return document.location.href=getUrl(c,a,p);};State.replace=function(c,a,p){return document.location.replace(getUrl(c,a,p));};return State.back=function(n){n=n||0;return history.go(-n);};})();}).call(this);
